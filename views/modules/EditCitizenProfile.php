...
if (isset($_SESSION)) {
    ...
    $Email = $_SESSION['citizen_login'];
             ...
             $stmt =(new Connection)->connect()->prepare("SELECT id, Fullname, Username, Phone, Address, Gender, roles, Status FROM masterlogin WHERE Email = :Email ");
