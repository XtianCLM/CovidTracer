            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                     <strong><h6 class="mb-0">Establishment Name</h6></strong> 
                    </div>
                    <div class="col-sm-9 text-secondary">
                       <strong><h5 class="mb-0"> <?php echo $estabname ; ?></h5></strong> 
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info "  href="EditEstabProfile">Edit</a>
                    </div>
                  </div>
                </div>
              </div>
