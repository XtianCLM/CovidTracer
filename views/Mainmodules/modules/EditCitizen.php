...
$EditidCitVer = $_GET['EditidCitVer'];

  $citizen = (new Connection)->connect()->query("SELECT * FROM masterlogin WHERE id = $EditidCitVer")->fetch(PDO::FETCH_ASSOC);
